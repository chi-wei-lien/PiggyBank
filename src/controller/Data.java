...
public class Data {
    public static void loadData(){
        ...
        for(int i = 0; i < FileController.expenseDataSet.size(); i++){
            ...
            System.out.println("expense: " + expense.getExpense() + "; date: " + expense.getDate() + "; detail: " + expense.getDetail());
        }
        for(int i = 0; i < FileController.incomeDataSet.size(); i++){
            Income income = FileController.incomeDataSet.get(i);
            System.out.println("income: " + income.getIncome() + "; date: " + income.getDate() + "; detail: " + income.getDetail());
        }
    }
}
